<template>
  ...
  <a-form-item label="下边距">
    <slider-input v-model:value="dataItem.titlePaddingBottom" prop="titlePaddingBottom" />
  </a-form-item>
  <a-form-item label="位置">
    <radio-group-button v-model:value="dataItem.titleAlign" :options="textAligns" prop="titleAlign" />
  </a-form-item>
  <a-divider orientation="left">控件</a-divider>
  ...
  <a-form-item label="边框宽度">
    <slider-input v-model:value="dataItem.widgetBorderWidth" prop="widgetBorderWidth" />
  </a-form-item>
  <a-form-item label="上边距">

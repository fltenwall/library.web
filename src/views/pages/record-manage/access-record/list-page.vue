...
import service, { AccessRecord } from '/@/api/record-manage/access-record';
...
export default defineComponent({
  ...
  setup() {
    // 实例
    const instance = reactive<Instance<AccessRecord>>({
      // 搜索实例
      searchInstance: null,
      // 列表实例
      listInstance: null
    ...
    const { onFetchData, onSearchData, queryData } = listPageMix<AccessRecord>(options);
